...
public class TestAspectJ01 {
	...
	public Object invoke(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		System.out.println("[Around before] Å¸°Ù °´Ã¼ÀÇ È£ÃâµÉ method : "+joinPoint.getSignature().getName());
		
		if(joinPoint.getArgs().length !=0) {
			System.out.println("[Around before] Å¸°Ù °´Ã¼ÀÇ È£ÃâÇÒ method¿¡ Àü´ÞµÇ´Â ÀÎÀÚ : "+joinPoint.getArgs()[0]);
		}
