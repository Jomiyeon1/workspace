...
public class MyBatisTestApp {
	...
	public static void main(String[] args) throws Exception{
		...
		User user = new User("user77","주몽","44","77-555-55","써울","email@email.com");
			 
		 //1. UserMapper10.addUser Test :: users table age/grade/redDate 입력값 확인할것 : OK
		 System.out.println(":: 1. addUser(INSERT)  ? ");
		 sqlSession.insert("UserMapper.addUser",user); System.out.println("\n");
		...
		//1. UserMapper10.getUserList Test 
			...
			search.setUserName( new String[]{ "주몽"} );
